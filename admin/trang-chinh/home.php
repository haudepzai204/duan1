<div class="container">
<a href="http://localhost/duanmau/admin/loai-hang/index.php?btn_list">
    <div class="cards row mt-5">
        ...
        <a href="http://localhost/duanmau/admin/hang-hoa/index.php?btn_list">
        ...
        <a href="http://localhost/duanmau/admin/khach-hang/index.php?btn_list">
...
<a href="http://localhost/duanmau/admin/binh-luan/">
...
<br>
<a href="http://localhost/duanmau/admin/donhang/">
        <div class="card-single col d-flex justify-content-around bg-warning text-white py-5 ml-3 ">
            <div>
